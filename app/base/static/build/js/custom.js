    ...
    if ($('#graphx').length) {
        ...
        Morris.Bar({
            ...
            data: [
                ...
                {x: '2020 Q3', y: 4, z: 3, a: 2},
                {x: '2020 Q4', y: 2, z: 4, a: 5}
            ],
            xkey: 'x',
            ykeys: ['y', 'z', 'a'],
            barColors: ['#26B99A', '#34495E', '#ACADAC', '#3498DB'],
    ...
    if ($('#graph_area').length) {
        ...
        Morris.Area({
            ...
            data: [
                ...
                {period: '2020 Q1', iphone: 10687, ipad: 4460, itouch: 2028},
                {period: '2020 Q2', iphone: 8432, ipad: 5713, itouch: 1791}
            ],
            xkey: 'period',
...
function init_echarts() {
    ...
    if ($('#mainb').length) {
        ...
        echartBar.setOption({
            title: {
                text: 'Active v/s confirmed',
                subtext: 'District wise status'
            },
            tooltip: {
                trigger: 'axis'
            },
            legend: {
                data: ['Active cases', 'Confirmed Cases','Recovered',"Deaths"]
            },
            toolbox: {
                show: false
            },
            ...
            xAxis: [{
                type: 'category',
                data:distNames
                    // ['MLP', 'PKD', 'KZH', 'KAN', 'KAZ', 'ALP', 'KOC', 'ERN', 'KTY', 'WAY', 'IDU', 'TRV']
            }],
            yAxis: [{
                type: 'value'
            }],
            series: [{
                name: 'Active',
                type: 'bar',
                data: [act[0], act[1], act[2], act[3], act[4], act[5], act[6], act[7], act[8], act[9], act[11]],
                markPoint: {
                    data: [{
                        type: 'max',
                        name: 'High.'
                ...
                name: 'Confirmed',
                type: 'bar',
                data: [con[0], con[1], con[2], con[3], con[4], con[5], con[6], con[7], con[8], con[9], con[11]],
                markPoint: {
                    data: [{
                        type: 'max',
                        name: 'High.'
    ...
    //             x: 'center',
    //             y: 'bottom',
    //             data: [act_today, con_today, rec_today, dec_today]
    //         },
    //         toolbox: {
    //             show: true,
    //             feature: {
